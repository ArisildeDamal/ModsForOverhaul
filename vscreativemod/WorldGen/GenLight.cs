...
namespace Vintagestory.ServerMods
{
    public class GenLightCreative : ModSystem
    {
        ...
        public override void StartServerSide(ICoreServerAPI api)
        {
            ...
            this.api.Event.ChunkColumnGeneration(this.OnChunkColumnGeneration, EnumWorldGenPass.Vegetation, "superflat");
            this.api.Event.ChunkColumnGeneration(this.OnChunkColumnGenerationFlood, EnumWorldGenPass.NeighbourSunLightFlood, "superflat");
