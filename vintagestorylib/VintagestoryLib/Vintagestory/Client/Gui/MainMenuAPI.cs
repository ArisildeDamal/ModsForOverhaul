...
namespace Vintagestory.Client.Gui
{
	public class MainMenuAPI : ICoreClientAPI, ICoreAPI, ICoreAPICommon
	{
		public MainMenuAPI(ScreenManager screenManager)
		{
			...
			this.inputapi = new MainMenuInputAPI(screenManager);
			this.renderapi = new MainMenuRenderAPI(screenManager);
			this.guiapi = new MainMenuGuiAPI(screenManager, this);
			this.eventapi = new MainMenuEventApi();
		...
		public bool IsShuttingDown
		{
			get
			{
				return this.screenManager.GamePlatform.IsShuttingDown;
			}
		}
		...
		public long ElapsedMilliseconds
		{
			get
			{
				return this.screenManager.GamePlatform.EllapsedMs;
			}
		}
		...
		public IAssetManager Assets
		{
			get
			{
				return this.screenManager.GamePlatform.AssetManager;
			}
		}
		...
		public ILogger Logger
		{
			get
			{
				return this.screenManager.GamePlatform.Logger;
			}
		}
		...
		public IModLoader ModLoader
		{
			get
			{
				return this.screenManager.modloader;
			}
		}
		...
		public IXPlatformInterface Forms
		{
			get
			{
				return this.screenManager.GamePlatform.XPlatInterface;
			}
		}
