...
namespace Vintagestory.Client.NoObf
{
	public class ShaderProgramMinimalGui : ShaderProgram
	{
		public ShaderProgramMinimalGui()
		{
			...
			this.VertexShader = new Shader(EnumShaderType.VertexShader, minimalVertex, "hardcoded");
			this.FragmentShader = new Shader(EnumShaderType.FragmentShader, minimalFrag, "hardcoded");
		}
