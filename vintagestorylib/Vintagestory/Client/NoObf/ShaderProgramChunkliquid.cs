...
namespace Vintagestory.Client.NoObf
{
	public class ShaderProgramChunkliquid : ShaderProgram
	{
		...
		public int DepthTex2D
		{
			set
			{
				base.BindTexture2D("depthTex", value, 1);
			}
		}
		...
		public Vec2f TextureAtlasSize
		{
			set
			{
				base.Uniform("textureAtlasSize", value);
			}
		}
		...
		public float WaterFlowCounter
		{
			set
			{
				base.Uniform("waterFlowCounter", value);
			}
		}
		...
		public Vec3f ReflectColor
		{
			set
			{
				base.Uniform("reflectColor", value);
			}
		}
		...
		public float SunSpecularIntensity
		{
			set
			{
				base.Uniform("sunSpecularIntensity", value);
			}
		}
		...
		public float DropletIntensity
		{
			set
			{
				base.Uniform("dropletIntensity", value);
			}
		}
		...
		public float WaterStillCounter
		{
			set
			{
				base.Uniform("waterStillCounter", value);
			}
		}
		...
		public Vec3f PlayerViewVec
		{
			set
			{
				base.Uniform("playerViewVec", value);
			}
		}
		...
		public Vec3f PlayerPosForFoam
		{
			set
			{
				base.Uniform("playerPosForFoam", value);
			}
		}
