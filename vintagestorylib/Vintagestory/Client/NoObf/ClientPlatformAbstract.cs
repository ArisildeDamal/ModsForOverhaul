...
namespace Vintagestory.Client.NoObf
{
	public abstract class ClientPlatformAbstract
	{
		...
		public abstract void RegisterOnFocusChange(ClientPlatformAbstract.OnFocusChanged handler);
		...
		{
			WindowResizedDelegate windowResized = this.WindowResized;
		...
		{
			if (ClientPlatformAbstract.singleIndexBufferId != 0)
			{
				GL.DeleteBuffer(ClientPlatformAbstract.singleIndexBufferId);
