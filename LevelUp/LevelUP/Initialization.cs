...
public class Initialization : ModSystem
{
    ...
    public override void StartClientSide(ICoreClientAPI api)
    {
        ...
        // Instantianting the Client api for shared functions
        sharedInstance.InstantiateAPI(clientInstance);
    }
    public override void StartServerSide(ICoreServerAPI api)
    {
        ...
        // Instantianting the Server api for shared functions
        sharedInstance.InstantiateAPI(serverInstance);
    }
    ...
    public override void Start(ICoreAPI api)
    {
        ...
        sharedInstance.InstantiateAPI(api);
